...
import { FileText, Settings, Home, Layers, User, BookOpen, Network, BarChart2, LayoutTemplate, LogOut, CalendarClock } from "lucide-react";
          ...
          <AccordionItem value="atendimento" className="border-none">
            ...
            <AccordionContent>
              <div className="flex flex-col gap-1 pb-2">
                ...
                <NavLink to="/agendamento" className={({ isActive }) => `flex items-center gap-3 px-6 py-2 rounded transition cursor-pointer ${isActive ? "bg-primary/15 text-primary border-l-2 border-primary" : "text-foreground/90 hover:bg-primary/10"}`}>
                  <CalendarClock className="w-5 h-5" /> Agendamentos
                </NavLink>
              </div>
            </AccordionContent>
          </AccordionItem>
