...
export const CHAMADO_STATUS_CONFIG: Record<ChamadoStatus, StatusConfig> = {
  ...
  rejeitado_operacional:{ label: 'Rej. Operacional',  color: 'text-red-600 dark:text-red-400',         badge: 'bg-red-500/10 text-red-700 border-red-500/25 dark:text-red-400' },
  rejeitado_financeiro:{ label: 'Rej. Financeiro',    color: 'text-rose-600 dark:text-rose-400',       badge: 'bg-rose-500/10 text-rose-700 border-rose-500/25 dark:text-rose-400' },
  ...
  cancelado:           { label: 'Cancelado',          color: 'text-slate-500 dark:text-slate-400',     badge: 'bg-slate-500/10 text-slate-600 border-slate-500/25 dark:text-slate-400' },
};
